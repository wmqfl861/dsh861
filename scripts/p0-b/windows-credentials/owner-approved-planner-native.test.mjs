...
// This does not establish owner-key custody, actual TLS, OS isolation or financial enforcement.
...
function setup(t) {
  ...
  config.agents.codex.baseUrl = 'https://synthetic.example.invalid/v1'
  ...
  return { input, envelope, seen, workspace, invoke: createOwnerApprovedPlanner(services) }
}
