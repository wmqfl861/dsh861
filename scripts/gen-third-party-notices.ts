...
const OVERRIDES: Record<string, { license?: string; repo?: string }> = {
  ...
  // No repository field in the published manifest (publisher page only).
  '@xai-official/grok': { repo: 'https://www.npmjs.com/package/@xai-official/grok' },
  // No repository field in the published manifest; prerelease manifests name
  // the publisher repo.
  'opencode-ai': { repo: 'https://github.com/anomalyco/opencode' },
